#!/bin/bash
#SBATCH --job-name=sparse_sst2
#SBATCH --output=logs/sparse_lora_sst2_%j.out
#SBATCH --error=logs/sparse_lora_sst2_%j.err
...
# Run training
echo "Starting Sparse LoRA training on SST-2..."
